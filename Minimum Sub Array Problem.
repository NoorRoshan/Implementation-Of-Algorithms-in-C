...
void minSubCrossArray(int * A, int low, int mid, int high);
void minSubArray(int * A, int low, int high);
...
int main(void){
    ...
    printf("The minimum sub array is :\n");
    for( i = start; i <= end; i ++){
        printf("Array[%d] = %d\n", i, A[i]);
    }
    printf("With the minimum sum = %d\n", sum);
